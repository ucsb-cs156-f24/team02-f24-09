...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_organization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-orgCode").fill("SKI");
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("Ski Club");
        page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("UCSB Ski and Snowboard Team");
        page.getByTestId("UCSBOrganizationForm-inactive").check(); // for true
        ...
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("Winter Sports");
        page.getByTestId("UCSBOrganizationForm-submit").click();

        assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslationShort"))
                .hasText("Winter Sports");
