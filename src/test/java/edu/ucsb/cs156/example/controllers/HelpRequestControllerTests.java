...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_helprequests() throws Exception {
                ...
                HelpRequest helpRequest1 = HelpRequest.builder()
                                .requesterEmail("tester@hotmail.com")
                                .teamId("09")
                                .requestTime(ldt1)
                                .tableOrBreakoutRoom("table 09 test")
                ...
                HelpRequest helpRequest2 = HelpRequest.builder()
                                .requesterEmail("tester2@hotmail.com")
                                .teamId("10")
                                .requestTime(ldt2)
                                .tableOrBreakoutRoom("table 10 test")
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/helprequests/post?requesterEmail=tester@hotmail.com&teamId=09&tableOrBreakoutRoom=table09&explanation=test exp&solved=false&requestTime=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_helprequest() throws Exception {
                ...
                HelpRequest helpRequestEdited = HelpRequest.builder()
                                ...
                                .teamId("10")
                                .requestTime(ldt2)
                                .tableOrBreakoutRoom("test table2")
                                .explanation("test exp 2")
                                .solved(true)
                                .build();
